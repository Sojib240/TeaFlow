...
const Philosophy = () => {
    return (
        <div className="w-full philosophy flex items-end pb-24 sm:pb-[8vw] ">
            <div className="px-5 pt-24 sm:pl-[14.44vw] sm:pt-[28vw] sm:pr-[5vw] flex flex-col sm:flex-row items-start gap-10 sm:gap-0">
                <h2 className="uppercase text-4xl sm:text-[7vw] text-white w-[65%] sm:leading-none font-GolosRegular">
                    philosophy
                </h2>
                <div className="sm:w-[45%] sm:bg-[#0d343a] sm:rounded-[3vw] p-0 sm:p-[5vw] font-GolosRegular">
                    <h2 className="text-lg sm:text-[1.2vw] leading-[10vw] sm:leading-[2.2vw] text-white ">
