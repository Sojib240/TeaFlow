        ...
        <div className="sm:pl-[5.15vw] px-5 sm:pr-[20vw] mt-12 sm:mt-[6vw] font-GolosRegular">
            {singleJournal  && (
                <>
                    ...
                    <div className="overflow-hidden w-auto h-auto border-b border-[#DEDADA] border-dashed">
                        <motion.p
                            initial={{ opacity: 0, y: "100%" }}
                            whileInView={{ opacity: 1, y: 0 }}
                            transition={{
                            ...
                            className="text-3xl sm:text-[3.6vw] uppercase font-GolosDemiBold pb-7 sm:pb-[2vw] pr-[24vw]"
                        >
