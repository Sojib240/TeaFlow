...
const Shop = () => {
    ...
    return (
        <div className="px-[5.15vw] mx-auto">
            ...
            <div className="flex justify-between gap-10 mt-16 sm:mt-[10vw] md:mt-[8vw]">
                <div className="w-[20%] mt-[-2.5vw]"></div>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 w-[80%] gap-y-10 gap-x-0 sm:gap-y-[5.5vw] sm:gap-x-[2vw] md:gap-x-[1vw] md:gap-y-[4.5vw]">
