                                            ...
                                            <div className="w-full">
                                                <div className="flex justify-between flex-col sm:flex-row gap-5 sm:gap-0 w-full">
                                                    <div className="flex flex-col items-start gap-[2vw] w-full">
                                                        ...
                                                        <button className="border-b border-[#ccc5c5] text-[#ACA6A6] text-[12px] cursor-pointer sm:text-[0.8vw] font-GolosRegular">
                                                            remove
                                                        </button>
                                                    </div>
                                                    <div className="flex sm:flex-col items-end w-full justify-between flex-row gap-[2.5vw]">
                                                        <div className=" flex gap-1 sm:gap-[0.15vw]">
                                                            ...
                                                            <div className="flex flex-col items-center gap-1 sm:gap-[0.15vw] h-12 sm:h-[2.5vw]">
                                                                <button className="bg-[#F1F1F1] w-8 sm:w-[1.5vw] font-GolosRegular h-1/2 rounded-[0.2vw] overflow-hidden text-base sm:text-[0.8vw] font-bold cursor-pointer">
                                                                    +
                                                                </button>
                                                                <button className="bg-[#F1F1F1] w-8 font-GolosRegular sm:w-[1.5vw] h-1/2 rounded-[0.2vw] overflow-hidden text-base sm:text-[0.8vw] font-bold cursor-pointer">
                                                                    -
                                                                </button>
                                                            </div>
                                                        </div>
