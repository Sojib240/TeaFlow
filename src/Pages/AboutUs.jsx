                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-end gap-[6vw] mt-[15vw] px-0 sm:px-[9.73vw] pb-[5vw]">
                    <div className="w-full sm:w-[60%] pb-[5vw]">
                        ...
                        <div className="mt-8 sm:mt-[5vw]">
                            ...
                            Join us on this journey to discover the
                ...
                <div className="px-0 sm:px-[9.73vw]">
                    <div className="flex flex-col sm:flex-row gap-[6vw] items-end pt-[20vw]">
                        ...
                        <div className="w-full sm:w-[58%]">
                            <div>
                                {`Another mission of our brand is to make the world a cleaner
                place!`
                                    .split("\n")
                                    .map((text, index) => (
                            ...
                            <div className="text-lg sm:text-[1.1vw] leading-[150%] sm:leading-[2vw] flex flex-col gap-6 sm:gap-[1.1vw] w-full">
                                <div className="mt-5 sm:mt-[3vw]">
                                    {`At Tea Flow, we believe it's our responsibility to make the
                world cleaner and healthier for everyone. That's why we're proud
                to introduce our newest initiative - every time you buy our
                premium tea, you help clean the ocean of plastic! We know that
                plastic pollution is a huge problem in our oceans, so we've
                partnered with 4ocean - a company dedicated to cleaning up our
                oceans and beaches. For every purchase you make, we invest a
                percentage of our profits into 4ocean's incredible efforts to
                remove plastic waste from our oceans. So not only will you enjoy
                our delicious teas, but you'll also be making a tangible
                difference in the fight against plastic pollution. With your
                help, we can create a cleaner, healthier world for generations
                to come. Join us on this mission to make a positive impact - one
